...
karaf@root> features:addurl mvn:org.opennms.plugins/piCarModule/1.0-SNAPSHOT/xml/features
karaf@root> features:install piCarModule

(or features:install piCarModule/1.0-SNAPSHOT for a specific version of the feature)

to install the licence specification in karaf use
karaf@root>  osgi:install -s  mvn:org.opennms.plugins/piCarModule.licence-spec/1.0-SNAPSHOT
